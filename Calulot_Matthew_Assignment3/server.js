...
// Loads cookie parser
var cookieParser = require('cookie-parser'); // Variable to require cookie-parser
app.use(cookieParser());
// Decode JSON post data
app.use(myParser.json());
// Load session, from Lab 15 and Assignment 3 Code
var session = require('express-session'); // Variable to require sessions
